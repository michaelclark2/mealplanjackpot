...
export default function Legend() {
  ...
  return (
    ...
    >
      <Text className={`text-xs font-bold sm:mb-0 ${isOpen && 'mb-2'}`}>
        Legend
      </Text>
      {isOpen && (
        <Row className="-mr-1.5 ml-2 w-full flex-wrap items-center justify-center space-x-2 sm:w-auto">
          <Row className="mt-1 space-x-2 rounded-3xl bg-white p-1 pr-2 sm:mt-0">
